...
class Key
{
  public:
    ...
    [[nodiscard]] unsigned int get_virtual_code() const
    {
        return m_vk;
    }

    [[nodiscard]] unsigned int get_scan_code() const
    {
        return m_sc;
    }

    [[nodiscard]] bool get_control() const
    {
        return m_ctrl;
    }

    [[nodiscard]] bool get_alt() const
    {
        return m_alt;
    }

    [[nodiscard]] bool get_shift() const
    {
        return m_shift;
    }

    void set_virtual_code(unsigned int vk)
    {
        m_vk = vk;
    }

    void set_scan_code(unsigned int sc)
    {
        m_sc = sc;
    }

    void set_control(bool ctrl)
    {
        m_ctrl = ctrl;
    }
